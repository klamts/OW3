          ...
          <div className="p-4 bg-white dark:bg-slate-800 rounded-xl shadow-lg">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6">
              <div className="w-full md:w-1/2 flex-shrink-0">
                <img src={currentContent.imageSrc||currentContent.image} alt={currentContent.text} className="w-full h-auto object-cover rounded-lg shadow-md" />
              </div>
              <div className="w-full md:w-1/2 flex items-start gap-2">
                ...
                <AudioButton src={currentContent.audioSrc||currentContent.audio} />
              </div>
            </div>
          </div>
        )}
