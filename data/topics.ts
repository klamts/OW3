...
export const topics: Topic[] = [
  ...
  },
  {
    ...
    title: "On the Move!",
    tabs: [
      { title: "Vocabulary 1", tabId: "unit3Vocabulary1" },
      { title: "Song", tabId: "unit3Song" },
      { title: "Grammar 1", tabId: "unit3Grammar1" },
      { title: "Vocabulay 2", tabId: "unit3Vocabulary2" },
      { title: "Grammar 2", tabId: "unit3Grammar2" },
      { title: "Reading", tabId: "unit3Reading" },
      { title: "Writing", tabId: "unit3Writing" },
      { title: "Extended Reading", tabId: "unit3ExtendedReading" },
    ]
  },
  {
    id: "unit4",
