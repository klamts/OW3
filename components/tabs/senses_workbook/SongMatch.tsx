  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-4">
        {data.audioSrc||data.audio && (
          <AudioButton src={secureAudio(data.audioSrc||data.audio)} title="Play Song" />
        )}
          ...
          <div className="w-full md:w-1/2 space-y-2">
            {questions.map((q) => (
              ...
              >
                ...
                {q.questionAudio && (
                  <AudioButton src={secureAudio(q.answerAudio)} />
                )}
                <UserRecordingControls></UserRecordingControls>
              </div>
            ))}
            ...
            {answers.map((a) => {
              ...
              return (
                ...
                >
                  ...
                  {a.answerAudio && (
                    <AudioButton src={secureAudio(a.questionAudio)} />
                  )}
                  <UserRecordingControls></UserRecordingControls>
                </div>
              );
