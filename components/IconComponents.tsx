...
export const LightBulbIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.311a7.5 7.5 0 01-7.5 0c-1.421-.662-2.805-1.523-4.098-2.586a11.96 11.96 0 01-1.622-2.311m15.82 4.897a11.962 11.962 0 01-1.622-2.311c-1.293-1.063-2.677-1.924-4.098-2.586m-7.5 0a7.5 7.5 0 017.5 0m-7.5 0a7.5 7.5 0 00-7.5 0M12 6a3.75 3.75 0 100 7.5A3.75 3.75 0 0012 6z" />
    </svg>
);
