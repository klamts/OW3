      ...
      <div className="space-y-12">
        {data.exercises.map((exercise, index) => {
            if (exercise.type === 'exercise1') {
                return <Exercise1 key={index} data={exercise} isTextVisible={isTextVisible} />;
            }
            if (exercise.type === 'exercise2') {
                return <Exercise2 key={index} data={exercise} isTextVisible={isTextVisible} />;
            }
            if (exercise.type === 'exercise3') {
                return <Exercise3 key={index} data={exercise} isTextVisible={isTextVisible} />;
            }
            return null;
        })}
      </div>
