...
import { ActivityCard, CheckAndResetButtons, AudioButton,UserRecordingControls } from './shared';
                ...
                {data.sentences.map((s, i) => {
                    ...
                    return (
                        <div key={i} className="flex flex-col sm:flex-row items-center gap-4 p-3 border border-slate-200 dark:border-slate-700 rounded-lg">
                            <img src={s.imageSrc||s.image} alt="" className="w-16 h-16 object-cover rounded-md"/>
                            ...
                            <AudioButton src={s.audioSrc||s.audio}/>
