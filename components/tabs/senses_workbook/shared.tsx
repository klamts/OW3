            ...
            <div className="flex items-center space-x-2 shrink-0 mt-2">
                ...
                {audioURL && recorderState === 'stopped' && (
                    <>
                        ...
                        <button onClick={resetRecording} className="p-2 rounded-full text-slate-500 hover:bg-slate-200 dark:hover:bg-slate-700 hover:text-red-500" title="Record again"><TrashIcon className="w-6 h-6" /></button>
                    </>
                )}
            </div>
        </>
