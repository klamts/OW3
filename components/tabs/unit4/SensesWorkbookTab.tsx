  ...
  return (
    <div className="space-y-6">
       <div className="flex justify-between items-center pb-2 border-b-2 border-slate-200 dark:border-slate-700">
        ...
        {spinWheelVocab && <Activities.SpinWheel data={spinWheelVocab} isTextVisible={isTextVisible} />}
        {circleActivity && (
          <>
            <div className="text-red-500">✅ CircleActivity is rendering</div>
            <Activities.CircleActivity data={circleActivity} isTextVisible={isTextVisible} />
          </>
        )}
